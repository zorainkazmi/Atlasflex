...
import logoImage from "../../../../public/assets/AtlasFlex-logo.svg";
  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-10 p-4 flex items-center justify-between">
      <aside className="flex items-center gap-2">
        <Image src={logoImage} width={40} height={40} alt="AtlasFlex Logo" />
        <span className="text-xl font-bold z-10">AtlasFlex.</span>
      </aside>
